      ...
      <div className="p-3 md:p-5 flex flex-col flex-1">
        ...
        <div className="mb-3 md:mb-4">
          ...
          <div className="flex items-start gap-1 md:gap-1.5 text-gray-500">
            ...
            <span className="text-[12px] md:text-[14px] font-medium leading-normal line-clamp-1">{hotel?.location || 'Unknown Location'}</span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mt-auto gap-3 sm:gap-4">
          <div className="flex flex-col">
            <span className="text-[10px] md:text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-1 md:mb-1.5">
              {nights} {dict.hotelsPage?.night || "đêm"}
            </span>
            {hotel?.originalPrice && (
            ...
            <div className="text-[16px] md:text-[22px] font-extrabold text-gray-900 leading-none tracking-tight">
              {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format((hotel?.price || 0) * nights)}
            </div>
          </div>
