      ...
      <div className="relative bg-white w-full max-w-[440px] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-10 pt-12 pb-6">
          ...
          <div className="flex flex-col gap-4 relative">
            <button onClick={() => signIn("google")} className="flex items-center justify-center w-full border-[1.5px] border-black rounded-full py-3.5 px-4 font-bold text-[15px] hover:bg-gray-50 transition-colors relative cursor-pointer">
